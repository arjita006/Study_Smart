<%@ Page Title="" Language="C#" MasterPageFile="~/account/account_master.master" AutoEventWireup="true" CodeFile="tutor_mockpaper.aspx.cs" Inherits="account_tutor_mockpaper" %>
		      ...
		      <ul id="menu" >
		        ...
		        <li id="menu-comunicacao" ><a href="tutor_edit.aspx"><i class="fa fa-book nav_icon"></i><span>Settings</span><span class="fa fa-angle-right" style="float: right"></span></a>
		         <%-- <ul >
		          ...
		          <li><a href="tutor_question.aspx"><i class="fa fa-book nav_icon"></i><span>Upload</span><span class="fa fa-angle-right" style="float: right"></span></a>
                  <ul>
                      <li><a href="tutor_question.aspx">Question Papers</a></li>
                      <li><a href="tutor_mockpaper.aspx">Mock Papers</a></li>
                      <li><a href="tutor_notes.aspx">Notes</a></li>s
                  </ul>
		       </li>
...
<!--slide bar menu end here-->
 ...
 <cc1:FilteredTextBoxExtender ID="FilteredTextBoxExtender1" TargetControlID="txtpapername"  runat ="server" ValidChars="qwertyuioplkjhgfdsazxcvbnmMNBVCXZASDFGHJKLPOIUYTREWQ "></cc1:FilteredTextBoxExtender>
                         <br />  
