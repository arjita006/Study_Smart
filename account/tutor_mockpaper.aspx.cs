...
public partial class account_tutor_mockpaper : System.Web.UI.Page
{
    ...
    protected void btnsubmit_Click(object sender, EventArgs e)
    {
        ...
        try
        {
                ...
                if (FileUpload1.HasFile && FileUpload2.HasFile)
                {
                    ...
                    if (check_ext(filename) && check_image(filename1))
                    {
                        ...
                        if (a < 512 && b < 512)
                        {
                            ...
                            string sql = "exec ques_mock @userid=" + tutor_id + ",@user_email='" + email + "', @mpapername='" + name + "',@mpaperfile='" + path + "',@mpaperimg=@image2,@mpaperyear='" + year + "',@langid=" + lang + ", @classid=" + cl + ",@classname='" + c + "',@langname='" + l + "', @action=4";
            ...
            {
                lblmssg.Text = "Please fill in all the fields";
                lblmssg.ForeColor = Color.Red;
            }
        }
        catch (Exception ex)
