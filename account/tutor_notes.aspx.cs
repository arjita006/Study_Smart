...
public partial class account_tutor_notes : System.Web.UI.Page
{
                ...
                if (FileUpload1.HasFile && FileUpload2.HasFile)
                {
                    ...
                    if (check_ext(filename) && check_image(filename1))
                    {
                        ...
                        if (a < 512 && b < 512)
                        {
                            ...
                            string sql = "exec notes @userid=" + tutor_id + ",@user_email='" + email + "', @notesname='" + name + "',@notesfile='" + path + "',@notesimage=@image2,@langid=" + lang + ", @classid=" + cl + ",@classname='" + c + "',@langname='" + l + "', @action=3";
