<%@ Page Title="" Language="C#" MasterPageFile="~/account/account_master.master" AutoEventWireup="true" CodeFile="tutor_profile.aspx.cs" Inherits="account_tutor_profile" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
    ...
    <div class="sidebar-menu" style="background-color:black;width:15%;height:730px">
		    ...
		    <div class="menu"style="background-color:black">
		      <ul id="menu" >
		        <li id="menu-home" ><a href="admin_dashboard.aspx"><i class="fa fa-tachometer"></i><span>Dashboard</span></a></li>
    	 ...
    	 <div class="login-head">
			...
			<div class="login-block">
              ...
              <br />
                ...
                <asp:TextBox ID="txtqualification" runat="server" ReadOnly="True"></asp:TextBox>
                <br />
                <asp:Label ID="lblpass" runat="server" Text="Password"></asp:Label>
                <asp:TextBox ID="txtpass" runat="server" TextMode="Password" ReadOnly="True"></asp:TextBox>
                <br />
