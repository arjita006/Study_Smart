...
public partial class question_mock : System.Web.UI.Page
{
                ...
                if (FileUpload1.HasFile && FileUpload2.HasFile)
                {
                    ...
                    if (check_ext(filename) && check_image(filename1))
                    {
                        ...
                        if (a < 512 && b < 512)
                        {
                            ...
                            string sql = "exec ques_mock @userid=" + user_id + ", @mpapername='" + name + "',@mpaperfile='" + path + "',@mpaperimg=@image2,@mpaperyear='" + year + "',@langid=" + lang + ", @classid=" + cl + ",@classname='" + c + "',@langname='" + l + "', @action=1";
