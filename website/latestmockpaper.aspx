<%@ Page Title="" Language="C#" MasterPageFile="~/website/website_master.master" AutoEventWireup="true" CodeFile="latestmockpaper.aspx.cs" Inherits="website_latestmockpaper" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
    <div style="margin-left:390px; margin-top:50px;width:500px;height:250px;overflow:auto">
     <%-- <asp:repeater ID="repeater1" runat="server" >
        <ItemTemplate>
            <table style="margin-left:350px;border:solid black;width:500px;height:25px; background-color:#f1f1f2; box-shadow: 10px 10px 5px #888888;overflow:auto">
                <tr><td rowspan="5" style="width:200px">
                   <asp:Image ID="Image1" align="center" runat="server" Height="90" Width="90" ImageUrl='<%#"data:image;base64,"+Convert.ToBase64String((byte[])Eval("m_paper_img"))%>' style="height:200px;width:200px"/> </td>
                    <td style="width:200px">Name:<asp:Label ID="Name" runat="server" align="center" Text='<%# Eval("m_paper_name") %>'/></td></tr>
                ...
                <tr><td style="width:200px">Language: <asp:Label ID="Label1" runat="server" Text='<%# Eval("lang_name") %>' /></td></tr>
                 <tr style="border-bottom:solid black"><td style="width:200px">
                     <a href="viewnotes.aspx?paper=<%# Eval("m_paper_file") %>&id=<%#Eval("m_paper_id") %>">Download</a>
        ...
        <asp:GridView ID="gvr_latestmock" runat="server" AutoGenerateColumns="False" OnPageIndexChanging="gvr_latestmock_PageIndexChanging" AllowPaging="true" PageSize="4" style="text-align:center;" CellPadding="4" HeaderStyle-Width="20%" HeaderStyle-HorizontalAlign="Center" HeaderStyle-Height="50px" GridLines="Both" Width="100%">
      ...
      <%-- <asp:BoundField DataField="m_paper_name" HeaderText="Paper Name"  SortExpression="m_paper_name" ItemStyle-HorizontalAlign="center" ItemStyle-Width="20%" />
       ...
       <asp:BoundField DataField="lang_name" HeaderText="Language Name" SortExpression="lang_name" ItemStyle-HorizontalAlign="center" ItemStyle-Width="20%"/>
            ...
            <ItemTemplate >
                ...
                <a href="latestmockpaper.aspx?paper=<%# Eval("m_paper_file") %>&id=<%#Eval("m_paper_id") %>"> Download</a>
            </ItemTemplate>
        </asp:TemplateField>
                    </Columns>
