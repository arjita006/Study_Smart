<%@ Page Title="" Language="C#" MasterPageFile="~/website/website_master.master" AutoEventWireup="true" CodeFile="latestnotes.aspx.cs" Inherits="website_latestnotes" %>

<asp:Content ID="Content1" ContentPlaceHolderID="head" Runat="Server">
</asp:Content>
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
     <div style="margin-left:375px; margin-top:50px; width:500px;height:250px;">
      ...
      <asp:GridView ID="gvr_latestnotes" runat="server" AutoGenerateColumns="False" OnPageIndexChanging="gvr_latestnotes_PageIndexChanging" AllowPaging="true" PageSize="4" style="text-align:center;" CellPadding="4" HeaderStyle-Width="20%" HeaderStyle-HorizontalAlign="Center" HeaderStyle-Height="50px" GridLines="Both" Width="500px">
      ...
      <%-- <asp:BoundField DataField="m_paper_name" HeaderText="Paper Name"  SortExpression="m_paper_name" ItemStyle-HorizontalAlign="center" ItemStyle-Width="20%" />
       ...
       <asp:BoundField DataField="lang_name" HeaderText="Language Name" SortExpression="lang_name" ItemStyle-HorizontalAlign="center" ItemStyle-Width="20%"/>
            ...
            <ItemTemplate >
                ...
                <a href="latestnotes.aspx?paper=<%# Eval("notes_file") %>&id=<%#Eval("notes_id") %>"> Download</a>
            </ItemTemplate>
        </asp:TemplateField>
                    </Columns>
